...
const styles = StyleSheet.create({
    container: {
      ...
      paddingTop: 20 + Constants.statusBarHeight,
        /*
            • no android sem constants o layout sobe
            • no ios ele desce (de acordo com aula)
        */
    },
    ...
    footer: {
      ...
      paddingVertical: 20,
      /*
        • na aula padding bottom 0 para remover espaço excessivo no bottom (ios)
        • no android ficou colado no footer
      */
